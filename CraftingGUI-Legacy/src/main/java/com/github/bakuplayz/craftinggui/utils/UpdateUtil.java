...
public final class UpdateUtil {
    ...
    public UpdateUtil(final @NotNull CraftingGUI plugin) {
        this.plugin = plugin;
        this.latestName = "";
        this.latestBody = "";
    ...
    private void fetchUpdate() {
        try {
            URL url = new URL("https://api.github.com/repos/Bakuplayz/CraftingGUI/releases");
    ...
    private boolean isUpdateForVersion() {
        return latestName.endsWith("(for 1.8 - 1.12.2)") ^ latestName.endsWith("(for 1.8 - latest)");
    }

    public void sendUpdateAlert(final @NotNull Player player) {
        player.sendMessage(colorize("&7---------- &aCraftingGUI&7 ----------"));
    ...
    public void sendUpdateAlert() {
        ...
        sender.sendMessage(colorize("&7---------- &aCraftingGUI&7 ----------"));
