...
public final class LanguageAPI {
    ...
    public enum Console {
        ...
        NOT_SUPPORTED_VERSION("This CraftingGUI.jar only supports 1.14 and up. In order to run the plugin, please change to the correct jar for your server version.");
